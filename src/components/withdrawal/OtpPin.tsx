        ...
        <div className="glass-card rounded-2xl p-2 md:p-8 shadow-2xl">
          ...
          <div className="mt-4 md:mt-10">
            ...
            <div className="space-y-4">
              <button className="w-full py-2 md:py-4 bg-primary text-background-dark font-black rounded-xl hover:shadow-[0_0_25px_rgba(6,249,249,0.5)] transition-all uppercase tracking-widest flex items-center justify-center gap-2">
