      ...
      <div className="max-w-4xl mx-auto space-y-6 md:space-y-12">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    className="w-full p-2 bg-slate-900 border border-slate-800 rounded-lg text-sm focus:ring-primary focus:border-primary text-white"
                    type="text"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  className="w-full p-4  bg-slate-900 border border-slate-800  rounded-lg text-sm focus:ring-primary focus:border-primary text-white placeholder:text-slate-600"
          ...
          <div className="bg-slate-950 rounded-xl border border-slate-800 p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between py-2 px-3 bg-slate-900 rounded-lg border border-slate-800">
                ...
                <div className="flex items-center justify-between py-2 px-3 bg-slate-900 rounded-lg border border-slate-800 opacity-60">
                  <div className="flex items-center gap-3">
                    <MdSmartphone className="text-slate-400" />
                    <div>
                      <p className="text-xs font-bold text-white">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className=" bg-slate-900 rounded-xl border border-slate-800 p-6 space-y-4">
              ...
              <div className="space-y-4 ">
                <div className="space-y-1.5">
                  ...
                  <select className="w-full p-2.5 bg-slate-800 border border-slate-700 rounded-full text-sm focus:ring-primary focus:border-primary text-white">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    className="w-full p-2.5 bg-slate-800 border border-slate-700 rounded-full text-sm focus:ring-primary focus:border-primary text-white font-mono tracking-widest"
                    type="text"
                    placeholder="**** **** **** 8829"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    className="w-full p-2.5 bg-slate-800 border border-slate-700 rounded-full text-sm focus:ring-primary focus:border-primary text-white uppercase"
                    type="text"
            ...
            <div className="border-2 border-dashed border-slate-800 rounded-xl flex flex-col items-center justify-center p-8 text-center group cursor-pointer hover:border-primary/50 transition-colors">
              <div className="size-12 rounded-full bg-slate-900 flex items-center justify-center mb-3 group-hover:bg-primary/10 group-hover:text-primary transition-all">
                <MdAdd />
              </div>
              <p className="text-sm font-bold text-white">Add Payout Method</p>
              <p className="text-xs text-slate-500">
        ...
        <div className="pt-8 border-t border-slate-800 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <button className="px-2 md:px-6 py-2 rounded-lg text-xs md:text-sm font-bold text-slate-400  hover:bg-slate-custom transition-all">
              Discard Changes
            </button>
