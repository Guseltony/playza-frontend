        ...
        <form className="flex flex-col gap-6">
          <div>
            ...
            <div className="flex justify-between gap-2 sm:gap-4">
              <input
                className="w-12 h-14 text-center bg-background-dark/50 border border-slate-300 dark:border-slate-700 rounded-lg text-primary text-xl font-bold focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                maxLength={1}
                type="text"
                placeholder="•"
              />
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  className="w-full bg-background-dark/50 border border-slate-300 dark:border-slate-700 rounded-lg py-3 pl-10 pr-4 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none"
                  placeholder="••••••••••••"
                  type="password"
                />
              </div>
