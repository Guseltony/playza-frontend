            ...
            <div className="grid md:grid-cols-3 gap-8">
              {steps.map((step, index) => (
                <div key={index} className="relative">
                  <div className="relative bg-gray-900/60 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/20 hover:border-cyan-500/50 transition-all group shadow-lg hover:shadow-cyan-500/20">
                    <div className="text-5xl font-bold text-gray-800 mb-4">
                      {step.number}
                    </div>
                    <step.icon className="w-12 h-12 text-cyan-400 mb-4 group-hover:scale-110 transition-transform drop-shadow-[0_0_10px_rgba(0,255,255,0.5)]" />
                ...
                <div key={player.rank} className="relative group">
                  ...
                  >
                    <div className="flex items-center gap-6">
                      ...
                      <div
                        className={`w-16 h-16 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg border-2 ${
                          player.rank === 1
                      ...
                      <div className="text-right">
                        <div className="text-3xl font-bold text-yellow-400 drop-shadow-[0_0_10px_rgba(255,215,0,0.5)]">
